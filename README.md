...
## Notas para el equipo-Trabajar siempre desde `C:\dev\` o equivalente, nunca desde carpetas sincronizadas con OneDrive.-Usar Git Bash, no PowerShell.-Ejecutar una vez por clon: `git config core.hooksPath .githooks`
